...
namespace 自定义Uppercomputer_20200727.修改参数界面
{
    public partial class Modification_numerical :Skin_VS
    {
        ...
        private void skinButton2_Click(object sender, EventArgs e)//用户点击了保存
        {
            ...
            if (numerical_EF.numerical_Parameter_inquire(this.skinTextBox8.Text) == "OK")
                numerical_EF.numerical_Parameter_modification(this.skinTextBox8.Text, numerical_Parameter(), tag_Common_Parameters(), general_Parameters_Of_Picture(), control_Location());//修改数据库参数
            else
            {
