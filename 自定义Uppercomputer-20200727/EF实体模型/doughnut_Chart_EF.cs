...
namespace 自定义Uppercomputer_20200727.EF实体模型
{
    ...
    {
        public static string doughnut_Chart_Parameter_inquire(string ID)//标签类参数ID查询
        {
        ...
        public doughnut_Chart_Class doughnut_Chart_Parameter_Query(string ID)//查询标签类全部参数
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
                doughnut_Chart_Class doughnut_Chart_Class = model.doughnut_Chart_Class.Where(pi => pi.ID == ID).FirstOrDefault();//查询数据库是否有该ID
        ...
        public doughnut_Chart_Class doughnut_Chart_Parameter_Query(string ID, string From)//查询标签类全部参数
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
        ...
        public string doughnut_Chart_Parameter_Add(doughnut_Chart_parameter parameter)//标签类主参数参数插入
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
        ...
        public string doughnut_Chart_Parameter_Add(Tag_common_parameters parameter)//标签类--主参数--字体参数插入
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
        ...
        public string doughnut_Chart_Parameter_Add(control_location parameter)//标签类位置坐标参数插入
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
        ...
        public string doughnut_Chart_Parameter_delete(string ID)//按钮类ID删除参数
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
                //执行删除按钮类主参数操作
        ...
        public string doughnut_Chart_modification(string ID, doughnut_Chart_parameter _Parameter, Tag_common_parameters tag_Common_, control_location _Location)//标签类ID修改参数
        {
            using (UppercomputerEntities2 model = new UppercomputerEntities2())
            {
