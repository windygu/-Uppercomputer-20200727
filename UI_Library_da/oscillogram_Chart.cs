...
namespace UI_Library_da
{
    ...
    {
        public bool waveform_ON { get; set; } = true;//折线图还是波形图--默认显示是折线图
        ...
        public void InitChart_load()
        {
            ...
            this.Titles[0].ForeColor = Color.RoyalBlue;
            this.Titles[0].Font = new System.Drawing.Font("Microsoft Sans Serif", 12F);
            //设置图表显示样式
        ...
        private void UpdateQueueValue()
        {
            ...
            if (waveform_ON)
            {
                for (int i = 0; i < num; i++)
                {
                    ...
                    curValue = curValue + oscillogram_Data;
                }
            }
        }
        /// <summary>
